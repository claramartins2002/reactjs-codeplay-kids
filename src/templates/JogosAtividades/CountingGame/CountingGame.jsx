...
// Função para gerar um número aleatório de objetos
const getRandomCount = () => Math.floor(Math.random() * 5) + 1;

// Tipos de frutas com imagens
const FRUIT_TYPES = [
    { name: 'Apple', icon: <img src="https://cdn-icons-png.freepik.com/256/1449/1449726.png?uid=R57935824&ga=GA1.1.1533935027.1722785762" alt="apple" className='fruit-img' /> },
    { name: 'Banana', icon: <img src="https://cdn-icons-png.freepik.com/256/11639/11639274.png?uid=R57935824&ga=GA1.1.1533935027.1722785762" alt="banana" className='fruit-img' /> },
    { name: 'Pear', icon: <img src="https://cdn-icons-png.freepik.com/256/1680/1680474.png?uid=R57935824&ga=GA1.1.1533935027.1722785762" alt="pear" className='fruit-img'/> },
];

// Função para gerar a quantidade de frutas de cada tipo
...
const CountingGame = () => {
    ...
    const countFruitsByType = () => {
        const counts = FRUIT_TYPES.map((fruit) => ({
            name: fruit.name,
